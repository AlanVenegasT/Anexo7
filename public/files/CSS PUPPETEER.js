...
<div class="container2">
    <div class="espaciotabladearriba"> 
        <table class="tablacompleta" style="width: 100%; ">
            <tr>
                <td colspan="8" style="font-size: 12px; text-align: center; line-height: 3px; background-color: #D9D9D9; border-color: #A6A6A6;">Sección II. Metas</td>
            </tr>
            <tr style="width: 100%; ">
  ...
  <div class="container2">
    <div class="espaciotabladearriba"> 
        <table class="tablacompleta" style="width: 100%; ">
            <tr>
                <td colspan="12" style="font-size: 12px; text-align: center; line-height: 3px; background-color: #D9D9D9; border-color: #A6A6A6;">Sección III. Acciones programadas y/o implementadas</td>
            </tr>
            <tr style="width: 100%; ">
...
<table class="espaciotabladearriba" style="page-break-inside: avoid;">
    ...
    <tbody id="tabla-body" class="bodytablahojauno">
      ...
      <td class="tresopciones">
        <div class="contenedortresopciones" >
          <div class="primeraopcion" >
            <label  ><input type="radio"  name="estado">Destrucción</label>
          </div>
          <div class="segundaopcion">
  ...
  <div class="container2">
    <div class="espaciotabladearriba"> 
        <table class="tablacompleta" style="width: 100%; ">
            <tr>
                <td colspan="12" style="font-size: 12px; text-align: center; line-height: 3px; background-color: #D9D9D9; border-color: #A6A6A6;">Sección VI. Acciones de los equipos y/o componentes fuera del PPCIEM </td>
            </tr>
            <tr style="width: 100%; ">
                <td style="width: 8%;" class="seccion3titulos" >Id del equipo o Componente</td>
                <td style="width: 8%; " class="seccion3titulos" >Tipo de equipo o Componente</td>
